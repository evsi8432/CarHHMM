...
\section{Case Study Results}
    ...
    \subsection{Parameter Estimates}
        ...
        \subsubsection{CarHHMM-DFT}
            ...
            %\begin{table}[ht]
            %
            %\caption{Estimates and standard errors of emission parameters for dive duration ($Y$), acceleration ($\Zone_{t,t^*}$), and willingness ($\Ztwo_{t,t^*}$) of the killer whale case study data under the full CarHHMM-DFT.}
            \begin{center}
            \scalebox{0.75}{
            \bgroup
            \centering
            ...
            \begin{tabular}{ccccc}
                ...
                \noindent Table \arabic{tablenum}: Estimates and standard errors of emission parameters for dive duration ($Y$), acceleration ($\Zone_{t,t^*}$), and willingness ($\Ztwo_{t,t^*}$) of the killer whale case study data under the full CarHHMM-DFT. The $\pm$ refers to the standard deviation of the parameter estimates for all 500 data simulations.
                \addtocounter{tablenum}{1}
        ...
        \subsubsection{HHMM-DFT}
            ...
            \noindent Table \arabic{tablenum}: Estimates and standard errors of emission parameters for dive duration ($Y$), acceleration ($\Zone_{t,t^*}$), and willingness ($\Ztwo_{t,t^*}$) of the killer whale case study data under the HHMM-DFT. The $\pm$ refers to the standard deviation of the parameter estimates for all 500 data simulations.
            \addtocounter{tablenum}{1}
        ...
        \subsubsection{CarHHMM}
            ...
            \end{center}
                ...
                \noindent Table \arabic{tablenum}: Estimates and standard errors of emission parameters for dive duration ($Y$), acceleration ($\Zone_{t,t^*}$), and willingness ($\Ztwo_{t,t^*}$) of the killer whale case study data under the CarHHMM. The $\pm$ refers to the standard deviation of the parameter estimates for all 500 data simulations.
                \addtocounter{tablenum}{1}
        ...
        \subsubsection{CarHMM-DFT}
            ...
            \end{center}
                ...
                \noindent Table \arabic{tablenum}: Estimates and standard errors of emission parameters for dive duration ($Y$), acceleration ($\Zone_{t,t^*}$), and willingness ($\Ztwo_{t,t^*}$) of the killer whale case study data under the CarHMM-DFT. The $\pm$ refers to the standard deviation of the parameter estimates for all 500 data simulations.
                \addtocounter{tablenum}{1}
