...
amount of movement data available in a variety of fields. This data can exhibit simultaneous behavioural processes occurring at different
time scales, resulting in increasingly complicated dependence structures. These processes can be modelled 
through a hierarchical hidden Markov model
(HHMM), which models the system as a
nested structure of hidden Markov models (HMMs).
At very short time scales, however, many basic assumptions of traditional HMMs are violated. We demonstrate how
