...
Some FDA models account for between-curve dependence, but these models are inadequate when modelling certain types of time dependencies. %, including that of Figure \ref{fig:data}.
For example, 
