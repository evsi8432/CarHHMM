...
%
FDA was originally developed to process curves assumed to be independent replicates, and within-curve fine-scale structure is not usually incorporated in FDA models.

However, sets of curves often exhibit complex sequential dependencies both between curves and within curves, especially in the case of biologging data \citep{Barajas:2017}.
...
To accommodate temporal dependence and changes in curve type, we turn to the field of
