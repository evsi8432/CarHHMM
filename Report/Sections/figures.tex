...
\begin{figure}[ht]
	\centering
	\includegraphics[width=5.5in]{../Plots/lagplot.png}
	\caption{Kernel Density estimates of Lag plot of all features (left) and the associated normal kernel density estimates (right)}
	\label{fig:lag}
\end{figure}
