...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\textwidth}
      ...
      \label{fig:HMM-DFT}
    \end{subfigure}
    \caption{Dependence structures of four HMM variants. Hidden state sequences are denoted as $X$ on the coarse-scale and $X^*$ at the fine scale. Observations (or emissions) are denoted by $Y$ on the coarse scale and $Y^*$ on the fine scale. Observations transformed using a moving window are denoted as $\Z$ and have corresponding hidden states $\tilde X^*$.}
    \label{fig:models}
\end{figure}
