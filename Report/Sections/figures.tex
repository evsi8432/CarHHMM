...
\begin{table}[ht]
\centering
\caption{Parameters estimates and standard errors for dive duration ($Y_t$), acceleration ($\Zone_{t,\tilde t^*}$), and wiggliness ($\Ztwo_{t,\tilde t^*}$) of the killer whale kinematic data for the full CarHHMM-DFT. The $\pm$ refers to the sample standard deviation of the parameter estimates for all 500 simulations.}
\scalebox{0.75}{
\begin{tabular}{ccccc}
...
\begin{figure}[ht]
	...
	\caption{Dive depth (top panel) and three-dimensional acceleration (bottom three panels) from a killer whale over approximately 5 hours. Note the data gaps occurring from 80-100 minutes and from 185-270 minutes. Both data gaps were excluded from analyses.}
	\label{fig:data}
\end{figure}
