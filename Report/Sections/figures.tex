...
\begin{figure}[ht]
	...
	\caption{Features of a particular set of killer whale dives and decoded estimates for the intra-dive behavioural states. The colour of the plot corresponds to the behavioural or dive state with the highest probability.}
...
\begin{figure}[ht]
	...
	\caption{Estimated probability distributions for each fine-scale observation in each behavioural state. Note that the distributions of acceleration do not take auto-correlation into account (see Table \ref{table:emis_dists_CarHHMM-DFT}).}
	\label{fig:fine_emis}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption{Simulated acceleration data for one dive. The colour of the line corresponds to the true fine-scale state of the subdive process, while the colour of the background corresponds to the true dive type of the simulated whale.}
	\label{fig:sim_data}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{Decoded probabilities of each dive type for 5 dives of one simulated data set. The colours correspond to the true dive or subdive type}
...
\begin{figure}[ht]
    ...
    \caption{Decoded probabilities of each subdive type for 5 dives of one simulated data set. The colours correspond to the true dive or subdive type}
    \label{fig:acc_fine}
\end{figure}