...
\title{Modelling state-switching functional data with hidden Markov models: supplementary material (case study)}%\query{Q1}
\date{}
...
\addtocounter{fignum}{1}
    ...
    \section{Likelihood Surfaces - CarHHMM-DFT}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the dive duration parameters $\mu_Y^{(i)}$ and $\sigma_Y^{(i)}$ for dive types $i = 1,2$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $(\hat \mu_Y,\hat \sigma_Y)$, which is denoted by a red star.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the coarse-scale probability transition matrix parameters $\eta_{1,2}$ and $\eta_{2,1}$. Recall that $\Gamma_{i,j} = \exp(\eta_{i,j}) / \sum_k \exp(\eta_{i,k})$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $(\hat \eta_{1,2},\hat \eta_{2,1})$, which is denoted by a red star.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the wiggliness parameters $\mu_W^{*(\cdot,i^*)}$ and $\sigma_W^{*(\cdot,i^*)}$ for subdive types $i^* = 1,2,3$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $(\hat \mu_W^{*(\cdot,i^*)}, \hat \sigma_W^{*(\cdot,i^*)})$, which is denoted by a red star.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the $x$-acceleration parameters $\mu_{A_x}^{*(\cdot,i^*)}, \sigma_{A_x}^{*(\cdot,i^*)}$ and $\text{logit}\left(\phi_{A}^{*(\cdot,i^*)}\right)$ for subdive types $i^* = 1,2,3$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $\left(\hat \mu_{A_x}^{*(\cdot,i^*)}, \hat \sigma_{A_x}^{*(\cdot,i^*)}, \hat \phi_{A}^{*(\cdot,i^*)}\right)$, which is denoted by a red star.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the $y$-acceleration parameters $\mu_{A_y}^{*(\cdot,i^*)}, \sigma_{A_y}^{*(\cdot,i^*)}$ and $\text{logit}\left(\phi_{A}^{*(\cdot,i^*)}\right)$ for subdive types $i^* = 1,2,3$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $\left(\hat \mu_{A_y}^{*(\cdot,i^*)}, \hat \sigma_{A_y}^{*(\cdot,i^*)}, \hat \phi_{A}^{*(\cdot,i^*)}\right)$, which is denoted by a red star.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the $z$-acceleration parameters $\mu_{A_z}^{*(\cdot,i^*)}, \sigma_{A_z}^{*(\cdot,i^*)}$ and $\text{logit}\left(\phi_{A}^{*(\cdot,i^*)}\right)$ for subdive types $i^* = 1,2,3$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $\left(\hat \mu_{A_z}^{*(\cdot,i^*)}, \hat \sigma_{A_z}^{*(\cdot,i^*)}, \hat \phi_{A}^{*(\cdot,i^*)}\right)$, which is denoted by a red star.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Log-likelihood of the CarHHMM-DFT as a function of the fine-scale probability transition matrix parameters associated both dive types ($\eta^{(i)*}_{i^*,j^*}$ for $i = 1,2$ and $i^*,j^* = 1,2,3$). Recall that $\eta^{(i)*}_{i^*,i^*} = 0$ and that $\Gamma^{(i)*}_{i^*,j^*} = \exp(\eta^{(i)*}_{i^*,j^*}) / \sum_{k^*} \exp(\eta^{(i)*}_{i^*,k^*})$. All other parameters and probability transition matrices are assumed to be the maximum likelihood estimates shown in Table (1) of Section 3.1. The log-likelihood is scaled by the log-likelihood of the maximum likelihood estimate $\hat \Gamma^{(i)*}$, which is denoted by a red star. Note that the long ridges of approximately equal likelihood corresponds to $\hat \Gamma^{(i)*}_{1,3} \approx \hat \Gamma^{(i)*}_{3,1} \approx 0$. This indicates that the whale never switches directly between subdive states 1 and 3.
        \addtocounter{fignum}{1}
        ...
        \subsection{CarHHMM-DFT}
            ...
            \begin{tabular}{ccccc}
                ...
                \multirow{3}{*}{$x$-Acc. $(m/s^2)$ -- $\left(\Zone_{t,\tilde t^*}\right)_x$}   & 1                                    & $0.449 (0.030)$ & $0.039 (0.001)$ & $0.968 (0.002)$ \\
                                                                                               & 2                                    & $0.210 (0.012)$ & $0.096 (0.002)$ & $0.829 (0.010)$ \\
                                                                                               & 3                                    & $0.232 (0.035)$ & $0.296 (0.010)$ & $0.607 (0.042)$ \\ \hline
                \multirow{3}{*}{$y$-Acc. $(m/s^2)$ -- $\left(\Zone_{t,\tilde t^*}\right)_y$}   & 1                                    & $0.450 (0.038)$ & $0.051 (0.001)$ & $0.968 (0.009)$ \\
                                                                                               & 2                                    & $0.437 (0.012)$ & $0.094 (0.002)$ & $0.829 (0.016)$ \\
