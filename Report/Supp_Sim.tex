...
\end{tabular}
        ...
        \noindent Figure \arabic{fignum}: Kernel density estimate of the distributions of dive duration parameter estimates ($\hat \mu_Y$ and $\hat \sigma_Y$). These estimates are associated with the HHMM-DFT and correspond to both dive types. The red star represents the true values of $\mu_Y$ and $\sigma_Y$ for both dive types.
        \addtocounter{fignum}{1}
...
\end{tabular}
        ...
        \noindent Figure \arabic{fignum}: Kernel density estimate of the distributions of acceleration parameter estimates ($\hat \mu^*_A$, $\hat \sigma^*_A$, and $\hat \phi^*_A$) for each subdive state. The red star represents the true values of $\mu^*_A$, $\sigma^*_A$, and $\phi^*_A$ for both subdive states. These estimates are for the CarHHMM. 
        \addtocounter{fignum}{1}
...
\multirow{6}{*}{CarHHMM-DFT}& \multirow{3}{*}{$\mu_W^*$}    & 1                                & $34.981$                         & $0.001$ $(p=0.978)$          & $1.026$                             & $0.658 \pm 0.088$                             \\
                            ...
                            &                               & 3                                & $9787.1$                         & $17.2$ $(p=0.718)$           & $1060.5$                            & $262.1 \pm 97.120$                             \\
                            & \multirow{3}{*}{$\sigma_W^*$} & 1                                & $23.849$                         & $-0.001$ $(p=0.991)$         & $0.989$                             & $0.658 \pm 0.088$                             \\
                            &                               & 2                                & $514.21$                         & $-2.47$ $(p=0.010)$          & $21.43$                             & $9.74 \pm 0.81$                             \\
                            &                               & 3                                & $14430$                          & $-33$ $(p=0.647)$            & $1596$                              & $262 \pm 97$                             \\ \hline
...
\multirow{6}{*}{CarHMM-DFT} & \multirow{3}{*}{$\mu_W^*$}    & 1                                & $35.034$                         & $0.054$ $(p=0.264)$          & $1.076$                             & $0.661 \pm 0.093$                             \\ 
                            ...
                            & \multirow{3}{*}{$\sigma_W^*$} & 1                                & $23.890$                         & $0.040$ $(p=0.401)$          & $1.058$                             & $0.661 \pm 0.093$                             \\
                            &                               & 2                                & $515.23$                         & $-1.45$ $(p=0.125)$          & $21.09$                             & $9.64 \pm 0.92$                             \\
                            &                               & 3                                & $14438$                          & $-25$ $(p=0.740)$            & $1661$                              & $280 \pm 136$                             \\
\end{tabular}
        \egroup
        }
        \end{center}
        ...
        \noindent Figure \arabic{fignum}: Kernel density estimate of the distributions of wiggliness parameter estimates ($\hat \mu^*_W$ and $\hat \sigma^*_W$) for each subdive state. The red star represents the true values of $\mu^*_W$ and $\sigma^*_W$ for both subdive states. These estimates are for the CarHHMM-DFT.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Kernel density estimate of the distributions of wiggliness parameter estimates ($\hat \mu^*_W$ and $\hat \sigma^*_W$) for each subdive state. The red star represents the true values of $\mu^*_W$ and $\sigma^*_W$ for both subdive states. These estimates are for the HHMM-DFT.
        \addtocounter{fignum}{1}
        ...
        \noindent Figure \arabic{fignum}: Kernel density estimate of the distributions of wiggliness parameter estimates ($\hat \mu^*_W$ and $\hat \sigma^*_W$) for each subdive state. The red star represents the true values of $\mu^*_W$ and $\sigma^*_W$ for both subdive states. These estimates are for the CarHMM-DFT.
        \addtocounter{fignum}{1}
